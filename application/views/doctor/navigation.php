...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
		...
		<li class="<?php if($page_name == 'accept_appointment')echo 'dark-nav active';?>">

<span class="glow"></span>

	<a href="<?php echo base_url();?>index.php?doctor/accept_appointment" >

		<i class="icon-check icon-2x"></i>

		<span><?php echo get_phrase('accept_appointment');?></span>
