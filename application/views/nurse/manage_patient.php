                            	...
                            	<a href="<?php echo base_url();?>index.php?nurse/manage_patient/delete/<?php echo $row['patient_id'];?>" onclick="return confirm('delete?')"
                                	...
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>" class="btn btn-red">
                                		...
                                		<i class="icon-trash"></i>
                                                ...
                                                <!--Adding the Views -->
                                <a href="<?php echo base_url();?>index.php?nurse/manage_patient/view/<?php echo $row['patient_id'];?>" 

                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('view');?>" class="btn btn-red">
