...

{
...

	{
		...
		function view_complains($param1 = '', $param2 = '', $param3 = '')

		{
			...
			$page_data['page_name']  = 'view_complains';
	
			$page_data['page_title'] = get_phrase('view_complains');
	
			$page_data['complaints']   = $this->db->get('complaints')->result_array();
