                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align:center;">
                                            ...
                                            <div id="thumbs">
                                                <a href="<?php echo base_url();?>uploads/diagnosis_report/<?php echo $row2['file_name'];?>" style="background-image:url(<?php echo base_url();?>uploads/diagnosis_report/<?php echo $row2['file_name'];?>)" title="<?php echo $row2['file_name'];?>"></a>
                                            </div>
                                            <?php endif;?>
                                            <a href="<?php echo base_url();?>uploads/diagnosis_report/<?php echo $row2['file_name'];?>" target="_blank" class="btn btn-primary">
                                                <i class="icon-download-alt"></i> <?php echo ('Download');?>
                                            </a>
                                        </td>
                            ...
                            <div class="padded">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <span class="label label-blue"><?php echo ('Report type can be x-ray, blood-test, etc.');?></span>
                                    </div>
                                </div>
                                <div class="control-group">
